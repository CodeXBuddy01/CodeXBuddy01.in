export const styles = {
    ...
    label: "text-[16px] text-Poppins text-black dark:text-white",
    input: "w-full text-black dark:text-white bg-transparent border rounded h-[40px] px-2 outline-none mt-[10px] font-Poppins",
    button: "w-full text-white bg-blue-500 hover:bg-blue-600 rounded h-[40px] font-Poppins mt-[10px]", // Added button style
  };
